                ...
                <div class="row p-30-0">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-filter mb-30">
                      <!-- filter link -->
                      <a href="#" data-filter="*" class="art-link art-current">Toutes les captures</a>
                      <!-- filter link -->
                      <a href="#" data-filter=".webTemplates" class="art-link">Applications web</a>
                      <!-- filter link -->
                      <a href="#" data-filter=".logos" class="art-link">Applications mobile</a>
                      <!-- filter link --></a>
                    </div>
                    <!-- filter end -->
                  ...
                  <div class="art-grid art-grid-3-col art-gallery">
                    ...
                    <div class="art-grid-item webTemplates">
                      ...
                      <div class="art-item-description">
                        <!-- title -->
                        <h5 class="mb-15">Cliquez pour visualiser</h5>
                        <!-- button -->
                      </div>
                      <!-- description end -->
                    ...
                    <div class="art-grid-item logos">
                      <!-- grid item frame -->
                      <a data-fancybox="gallery" href="img/works/original-size/12.jpg" class="art-a art-portfolio-item-frame art-square">
                        <!-- img -->
          ...
          <div class="art-menu-bar-frame">
            ...
            <div class="art-scroll-frame">
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu">
                  <!-- menu item -->
                  <li class="menu-item current-menu-item"><a href="portfolio">Portfolio</a></li>
                  <!-- menu item -->
